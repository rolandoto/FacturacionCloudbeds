...
const InvoinceRelax =() =>{
  ...
  const  {PostPaymentCloubeds} = useCloubesActions()
  ...
  const [checkboxes, setCheckboxes] = useState({
    ...
    const { ListClient,ProductDian} =useSelector((state) => state.CitySigoSlice)
  ...
  const filterItemsExecento = ProductDian?.filter(item =>{
    ...
    useEffect(() =>{
     ...
     const {City,
     PaymentSiigo,InvoinceDianSiigo}= useSelector((state) => state.CitySigoSlice)
